	...
	<div class="col-12  pt-3">
		<div class="card">
			<div class="card-header">
				...
				{{-- <button type="button" class="btn btn-light">Latest Posts</button> --}}
...
<div class="row">
	...
	<div class="col-lg-9 mb-4">
		...
		<div class="row pt-lg-4 mb-lg-4">
			<div class="col-lg-5">
				<a href="{{$post->path()}}"><img src="{{ asset('uploads/'.$post->image) }}" alt="{{$post->image_alt}} " class="img-fluid rounded "></a>
			</div>
			<div class="col-lg-7">
				<div class="entry2">
					...
					<div class="excerp">
						...
						@endforeach --}}
						<h2 class="pt-2 mb-2  text-dark"><a class="p-h" href="{{$post->path()}} ">{{$post->title}} </a></h2>
						
						<p class="p-s">{!! Str::limit($post->body, $limit = 250, $end = '..') !!} <a href="{{$post->path()}} ">...Read more</a> </p>
						...
						dd($newDateFormat2);
						@endphp --}}
						<span class="text-dark">&nbsp;&nbsp; {{ date_format($post->created_at,"M d,Y")}}</time>{{" · ". $post->reading_time}} read </span>
