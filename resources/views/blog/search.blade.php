	...
	<div class="row">
		...
		<div class="col-lg-9 mb-4">
			...
			<div class="row pt-lg-4 mb-lg-4">
				<div class="col-lg-5">
					<a href="{{$post->path()}}"><img src="{{ asset('uploads/'.$post->image) }}" alt="Image" class="img-fluid rounded pt-md-4"></a>
				</div>
				<div class="col-lg-7">
					<div class="entry2">
						...
						<div class="excerp">
							...
							dd($newDateFormat2);
							@endphp --}}
							<span class="text-dark">&nbsp;&nbsp;{{date_format($post->created_at,"d.M.y") }} </span>
						</div>
